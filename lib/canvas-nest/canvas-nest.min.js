...
//rebuild by neat </0?-1:1,m.fillrect(o.x-.5,o.y-.5,1,1);for(t=0;t<n.length;t++){e=n[t];if(o!==e&&null!==e.x&&null!==e.y){a=o.x-e.x,u=o.y-e.y,x=a*a+u*u;x<e.max&&(e===w&&x></0?-1:1,o.ya*=o.y>