...
//rebuild by neat </j.eventlag.lagthreshold?(o.progress=100,clearinterval(e)):o.progress=100*(3></2:0<(u=s.readystate)&&4></=arguments.length?q.call(arguments,1):[],p.unshift("ignore"),n=e.apply(null,t),p.shift(),n},c.track=function(){var></10?"0":"",n+=0|this.progress),t.children[0].setattribute("data-progress",""+n)),this.lastrenderedprogress=this.progress},t.prototype.done=function(){return></this.bindings[t].length;)s.push(this.bindings[t][n].handler===e?this.bindings[t].splice(n,1):n++);return></=arguments.length?q.call(arguments,2):[],"function"==typeof>