  ...
  var Pangu = function () {
    ...
    _createClass(Pangu, [{
      ...
      value: function spacing(text) {
        ...
        if (text.length <= 1 || !any_cjk.test(text)) { return text; } var self="this;" newtext="text;" function (match, leftcjk, symbols, rightcjk) fullwidthsymbols="self.convertToFullwidth(symbols);" "".concat(leftcjk).concat(fullwidthsymbols).concat(rightcjk); }); cjk, symbols) "".concat(cjk).concat(fullwidthsymbols); '$1 $2'); '$1：$2'); '$1$2$3'); "$1's"); $2$3$4 $5'); $3'); $2 '$1$2'); $2$3$4'); '$1$2$3 $4'); '・'); newtext; }, key: "spacingtext", value: spacingtext(text) callback="arguments.length"> 1 && arguments[1] !== undefined ? arguments[1] : function () {};
        var newText;
