...
//rebuild by neat </0?-1:1,m.fillrect(r.x-.5,r.y-.5,1,1);for(t=0;t<n.length;t++){e=n[t];if(r!==e&&null!==e.x&&null!==e.y){o=r.x-e.x,a=r.y-e.y,c=o*o+a*a;c<e.max&&(e===f&&c></0?-1:1,r.ya*=r.y></e.length;t++){if(n.indexof(e[t])>