<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" allowfullscreen="allowfullscreen" allow="autoplay; fullscreen" src></iframe><video class="fancybox-video" controls controlslist="nodownload" poster>' +
        '<source src type>' +
        'Sorry, your browser doesn\'t support embedded videos, <a href>download</a> and watch with your favorite video player!' +
        "</video><div class="fancybox-container" role="dialog" tabindex="-1">' +
